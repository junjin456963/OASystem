...
<li class="hea-li">
    ...
    <div id="apDiv21">
      <label><span class="STYLE8"><input type="button" value="返回" onClick="history.go(-1)"></span></label>
</div>
<div class='wrap-body'>
        <div class='wrap-nav'>
        	<h1 class='wrap-nav-head check-wrap-nav-head'>报销单管理</h1>
        	<ul class='wrap-nav-list'><li><a href='Fin_addEa.jsp'>添加报销单</a></li>
            <li><a href='Fin_payEa.jsp'>付款</a></li>
    			<li class='wrap-nav-show'><a href='Fin_findEa.jsp'>查询报销单</a></li>
        	</ul>
        </div>
      <div class='wrap-con'>
