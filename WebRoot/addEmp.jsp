    ...
    <div class='wrap-body'>
        <div class='wrap-nav'>
        	...
        	<ul class='wrap-nav-list'>
    			<li class='wrap-nav-show'><a href='getPosDepToAddEmp'>人员添加</a></li>
                <li><a href="getPosDep">人员查找</a></li>
        	</ul>
        </div>
        <!-- 下面是content右边部分 -->
        <div class='wrap-con'>
        	<div class='wrap-con-nav'>
    	    	<ul class='clearfix'>
    	    		...
    	    		<li class='wrap-con-show'><a>人员添加页面</a></li>
    	    	</ul>
        	</div>
...
<td align="right"><span class="STYLE8"> 
							...
							<td>
								<p>
								  <input type="text" name="emp.empName">
							  </p>
							<p>&nbsp;								          </p></td>
</tr>
...
<td align="right"><span class="STYLE8"> 
 						 ...
 						 <tr>
							...
							<td>
								 <p>
								   <input type="text" name="emp.empPw">
							  </p>
						    <p>&nbsp;								             </p></td>
 						</tr>
 						<!--
