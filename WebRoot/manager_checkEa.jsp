    ...
    <div id="apDiv16">
      ...
      <s:iterator value="claimList"> 
        <tr>
          ...
          <td align="center">          
          <s:a href="CheckClaimDetail?claId=%{claId}">审核</s:a>&nbsp;
          </td>
        </tr>
       </s:iterator>
...
<!--<div id="apDiv20"><span class="STYLE8"> 第一页 上一页 当前第X页 共X页 下一页 尾页</span></div>-->
<div class='wrap-body'>
        <div class='wrap-nav'>
        	<h1 class='wrap-nav-head check-wrap-nav-head'>报销单管理</h1>
        	<ul class='wrap-nav-list'><li><a href='manager_addEa.jsp'>添加报销单</a></li>
            <li class='wrap-nav-show'><a href='manager_checkEa.jsp'>审批报销单</a></li>
      ...
      <div class='wrap-con'>
       	<div class='wrap-con-nav'>
    	    	<ul class='clearfix'>
    	    		<li class='wrap-con-show'><a>审批报销单页面</a></li>
