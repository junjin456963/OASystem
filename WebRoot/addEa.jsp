    ...
    <div class="hea-date clearfix">
     ...
     <form action="SaveSession" name="fm" id="form1">
      <table  border="1" bordercolor="#CCCCCC">
        ...
        <tr>
          <td align="center"><input name="det.itemName" type="text" id="product" ></td>
          <td align="center"><input name="det.claMoney" type="text" id="cost" ></td>
          <td align="center"><input  name="det.reason" type="text" id="reason" ></td>
          <td>
...
<div class='wrap-body'>
        <div class='wrap-nav'>
        	...
        	<ul class='wrap-nav-list'><li class='wrap-nav-show'><a href='addEa.jsp'>添加报销单</a></li>
    			<li><a href='findEa.jsp'>查询报销单</a></li>
        	</ul>
        </div>
      <div class='wrap-con'>
       	<div class='wrap-con-nav'>
    	    	<ul class='clearfix'>
    	    		<li class='wrap-con-show'><a>报销单添加首页</a></li>
    	    	</ul>
       	</div>
      </div>
