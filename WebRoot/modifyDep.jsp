    ...
    <div class='body'>
      ...
      <div class='wrap-con'>
        	<div class='wrap-con-nav'>
    	    	<ul class='clearfix'>
    	    		<li class='wrap-con-show'><a>部门信息修改页面</a></li>
   	    	  </ul>
        	</div>
            <div class="wrap-content"> 
            <!-- 这里放你写的内容 -->
            <div id="all" style="padding: 0px; border: hidden 0px #000000;"  align=center>
              <form name="" method="post" action="modifyDep">
                <table id="formtable" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								<p>
								 <input type="text" name="dep.depId" value=${requestScope.dep.depId}>
						...
						<tr>
							...
							<td>
								<p>
								  <input type="text" name="dep.depName" value=${requestScope.dep.depName}>
							  </p>
								<p>&nbsp;								    </p></td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="dep.employee.empId" value=${requestScope.dep.employee.empId}>
														</td>
						</tr>
				</table>
