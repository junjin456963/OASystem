...
<div class='wrap-body'>
      ...
      <div class='wrap-con'>
       	<div class='wrap-con-nav'>
    	    	<ul class='clearfix'>
    	    		<li class='wrap-con-show'><a>报销单审批页面</a></li>
    	  </ul>
       	</div>
        <p>&nbsp;</p>
                   <table width="635" height="247" border="1" bordercolor="#CCCCCC">
                     <tr>
                     ...
                     <tr>
                       ...
                       <th><span class="STYLE8">费用说明</span></th>
                       <th></th>
                     </tr>
                    <s:iterator value="detailList">                 
                     ...
                     <tr>
                       <th><span class="STYLE8">审核意见</span></th>
                       <th colspan="3"><label>
                       <textarea name="app.appRes" id="textarea" cols="62" rows="5"></textarea>
                       </label></th>
                     </tr>
                   </table>
                         <br>
					   	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					    <span class="STYLE8">
					    <s:a href="addApproval?claId=%{cla.claId}&is=1">审核通过</s:a>
					    </span>
					     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					    <span class="STYLE8">
					     <s:a href="addApproval?claId=%{cla.claId}&is=2">审核拒绝</s:a>
					    </span>
					     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					    <span class="STYLE8">
					     <s:a href="addApproval?claId=%{cla.claId}&is=3">打回</s:a>
					    </span>
					    <!--
					     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					    <span class="STYLE8"><input type="button" value="返回" onclick="history.go(-1)"></span>
					    -->
                  <p>&nbsp;</p>
    </div>
