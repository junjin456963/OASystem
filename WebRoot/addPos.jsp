    ...
    <div class='wrap-body'>
        <div class='wrap-nav'>
        	...
        	<ul class='wrap-nav-list'>
    			<li class='wrap-nav-show'><a href='addPos.jsp'>添加职务</a></li>
    			<li><a href='findPos.jsp'>查找职务</a></li>
        	</ul>
        </div>
        ...
        <div class='wrap-con'>
        	<div class='wrap-con-nav'>
    	    	<ul class='clearfix'>
    	    		<li class='wrap-con-show'><a>职务添加页面</a></li>
   	    	  </ul>
        	</div>
				...
				<form method="post" action="addPostServlet">
				  <table id="formtable" cellpadding="0" cellspacing="0" width="90%"
						...
						--><tr>
							...
							<td>
								<p>
								  <input type="text" name="pos.postName" />
							  </p>
							<p>&nbsp;								          </p></td>
						</tr><!--
						<tr>
