...
<li class="hea-li">
    ...
    <div id="apDiv16">
      <table border="1" bordercolor="#CCCCCC">
        <tr>
          <th width="100" height="32"><span class="STYLE8">编号</span></th>
          <th width="150"><span class="STYLE8">填报日期</span></th>
          <th width="150"><span class="STYLE8">填报人</span></th>
          <th width="150"><span class="STYLE8">待处理人</span></th>
          <th width="150"><span class="STYLE8">金额</span></th>
          <th width="150"><span class="STYLE8">状态</span></th>
          <th width="250"><span class="STYLE8">操作</span></th>
        </tr>
      ...
      <s:iterator value="claimList"> 
        <tr>
          ...
          <td >      
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
          <s:a href="ModifyPayCost?claId=%{claId}">付款</s:a>
          </td>
        </tr>
       </s:iterator>
    ...
    <div id="apDiv20"><span class="STYLE8"> </span></div>
<div class='wrap-body'>
        <div class='wrap-nav'>
        	<h1 class='wrap-nav-head check-wrap-nav-head'>报销单管理</h1>
        	<ul class='wrap-nav-list'><li><a href='Fin_addEa.jsp'>添加报销单</a></li>
            <li class='wrap-nav-show'><a href='FindPayClaim'>付款</a></li>
    			<li><a href='Fin_findEa.jsp'>查询报销单</a></li>
        	</ul>
        </div>
      <div class='wrap-con'>
       	<div class='wrap-con-nav'>
    	    	<ul class='clearfix'>
    	    		<li class='wrap-con-show'><a>财务付款页面</a></li>
